...
(function (g) {
    ...
    function f(a, b, c, f) {
        return function () {
            ...
            (e = g.parseXML(a.responseText)) && e.firstChild ? (a = g.extend({}, a, {responseXML: e}), c(a)) : f && f(a.responseText ? "Invalid XML" : b)
        }
    }
    ...
    g.ajax = function (a, b, c) {
        ...
        if (e && g.exists(d.XDomainRequest))k = new XDomainRequest, k.onload = f(k, a, b, c), k.onerror =
            h(c, a, k); else if (g.exists(d.XMLHttpRequest)) {
    ...
    g.bounds = function (a) {
        ...
        return{left: c, top: f, width: e, height: a, right: c + e, bottom: f + a}
    };
    g.empty = function (a) {
...
(function (g) {
    ...
    var a = {}, b, c = {}, k = 0, e = g.exists, m = {}, l = !1, j = g.css = function (d, q, n) {
        ...
        for (var m in q) {
            ...
            a:{
                j = m;
                var p = q[m];
                if ("undefined" === typeof p)j = void 0; else {
                    var z = n ? " !important" : "";
    ...
    g.clearCss = function (b) {
        for (var e in c)0 <= e.indexOf(b) && delete c[e];
    ...
    g.dragStyle = function (b, a) {
        g.css(b, {"-webkit-user-select": a, "-moz-user-select": a,
            "-ms-user-select": a, "-webkit-user-drag": a, "user-select": a, "user-drag": a})
    };
    g.transitionStyle = function (b, a) {
        navigator.userAgent.match(/5\.\d(\.\d)? safari/i) || g.css(b, {"-webkit-transition": a, "-moz-transition": a, "-o-transition": a})
    };
    g.rotate = function (a, b) {
        g.transform(a, "rotate(" + b + "deg)")
    };
    j(".jwplayer " + " div span a img ul li video".split(" ").join(",.jwplayer ") + ", .jwclick", {margin: 0, padding: 0, border: 0, color: "#000000", "font-size": "100%", font: "inherit", "vertical-align": "baseline", "background-color": "transparent",
        "text-align": "left"});
    j(".jwplayer ul", {"list-style": "none"})
})(jwplayer.utils);
(function (g) {
    ...
    var h = g.stretching = {NONE: "none", FILL: "fill", UNIFORM: "uniform", EXACTFIT: "exactfit"}
})(jwplayer.utils);
(function (g) {
    g.parsers = {localName: function (h) {
        ...
        d.onreadystatechange = function () {
            if (4 === d.readyState)if (200 === d.status) {
                ...
                for (m = 0; m < c.length; m++) {
                    ...
                    e = l;
                    e.text && (k.push(e), e.end && (k.push({begin: e.end, text: ""}), delete e.end))
                }
    ...
    (h.jwparser = function () {
        ...
        for (var a = [], b = [], c = g.utils.xmlAttribute, k = 0; k < f.childNodes.length; k++) {
            ...
            if ("jwplayer" == e.prefix) {
                var m = h.localName(e);
                "source" == m ? (delete d.sources, a.push({file: c(e, "file"), "default": c(e, "default"), label: c(e, "label"), type: c(e, "type")})) : "track" == m ? (delete d.tracks, b.push({file: c(e, "file"), "default": c(e, "default"), kind: c(e, "kind"), label: c(e, "label")})) : (d[m] = g.utils.serialize(h.textContent(e)), "file" ==
    ...
    c.parseGroup = function (k, e) {
        ...
        for (l = 0; l < b(k); l++)if (m = k.childNodes[l], "media" == m.prefix && d(m))switch (d(m).toLowerCase()) {
            case "content":
                ...
                f(m, "url") && (e.sources || (e.sources = []), e.sources.push({file: f(m, "url"), type: f(m, "type"), width: f(m, "width"), label: f(m, "label")}));
                break;
            case "title":
                e.title =
                    a(m);
            ...
            case "subtitle":
                ...
                if (0 < f(m, "lang").length) {
                    var q = g;
                    m = f(m, "lang");
                    var n = {zh: "Chinese", nl: "Dutch", en: "English", fr: "French", de: "German", it: "Italian", ja: "Japanese", pt: "Portuguese", ru: "Russian", es: "Spanish"};
                    m = n[m] ? n[m] : m;
                    q.label = m
                }
                j.push(g)
    ...
    g.srt = function (h, f, d) {
        ...
        function b(a) {
            ...
            for (a = 0; a < c.length; a++)if ("WEBVTT" != c[a]) {
                ...
                e.text && (b.push(e), e.end && !d && (b.push({begin: e.end, text: ""}), delete e.end))
            }
...
(function (g) {
    ...
    g.captions = function (a, e) {
        ...
        function t(a) {
            h.isMobile() || !A.length ? v.hide() : C == b && 0 < E ? (v.show(), I ? l({fullscreen: !0}) : (y(), a && setTimeout(y, 500))) : v.hide()
        }
        ...
        function z() {
            var a = [];
            a.push({label: "Off"});
            for (var b = 0; b < A.length; b++)a.push({label: A[b].label});
            return a
        }

        var w = a, s, u = {back: !0, color: "#FFFFFF", fontSize: 15}, x = {fontFamily: "Arial,sans-serif", fontStyle: "normal", fontWeight: "normal", textDecoration: "none"}, v, C, D, A = [], E = 0, I = !1, B, J = new f.eventdispatcher;
        h.extend(this, J);
        ...
        this.setCurrentCaptions = function (a) {
            if (0 <= a && E != a && a <= A.length) {
                ...
                J.sendEvent(b, {type: b, tracks: a, track: E})
            }
        };
        ...
        w.jwAddEventListener(f.JWPLAYER_PLAYLIST_ITEM, function () {
            ...
            for (c = E = 0; c < b.length; c++)if (e = b[c].file)b[c].label || (b[c].label = c.toString()), A.push(b[c]);
            for (c = 0; c < A.length; c++)if (A[c]["default"]) {
                d = c + 1;
                break
            }
            ...
            b = z();
            J.sendEvent(a, {type: a, tracks: b, track: E})
        });
        ...
        w.jwAddEventListener(f.JWPLAYER_READY,
            function () {
                for (var a in u)e && void 0 != e[a.toLowerCase()] ? "color" == a ? x.color = "#" + String(e.color).substr(-6) : x[a] = e[a.toLowerCase()] : x[a] = u[a];
...
(function (g) {
    g.captions.renderer = function (h, f) {
        function d(b) {
            c({left: "0px", top: "0px", visibility: "hidden"});
            g.innerHTML = b;
            r = "" == b ? "hidden" : "visible";
            setTimeout(a, 20)
        }
        ...
        function a() {
            ...
            c({maxWidth: q + "px", fontSize: a + "px", lineHeight: b + "px", visibility: r});
        ...
        f.appendChild(g);
        c({color: "#" + h.color.substr(-6), display: "block", fontFamily: h.fontFamily, fontStyle: h.fontStyle, fontWeight: h.fontWeight, height: "auto", margin: "0 0 0 0", padding: "3px 9px", position: "absolute",
            textAlign: "center", textDecoration: h.textDecoration, wordWrap: "break-word", width: "auto"});
        h.back ? c({background: "#000"}) : c({textShadow: "-2px 0px 1px #000,2px 0px 1px #000,0px -2px 1px #000,0px 2px 1px #000,-1px 1px 1px #000,1px 1px 1px #000,1px -1px 1px #000,1px 1px 1px #000"});
        this.show = function () {
            c({display: "block"});
            a()
        };
...
(function (g) {
    ...
    g = f.transitionStyle;
    var c = "button", k = "text", e = "divider", m = "slider", l = "100%", j = {display: "none"}, r = {display: y}, q = !1, n = !0, t = null, y = void 0, p = window, z = document;
    h.controlbar = function (g, s) {
        ...
        function I() {
            ...
            b("#" + Z, {height: oa, bottom: za ? 0 : P.margin});
            b(B(".jwtext"), {font: P.fontsize + "px/" + H("background").height + "px " + P.font, color: P.fontcolor, "font-weight": P.fontweight});
            b(B(".jwoverlay"), {bottom: oa});
            0 < P.maxwidth && b(B(), {"max-width": P.maxwidth})
        }
        ...
        function O(a) {
            switch (a.type) {
                case e:
                    var d;
                    a.width ? (d = J(), d.className = "jwblankDivider", b(d, {width: parseInt(a.width)})) : a.element ? d = F(a.element) : (d = F(a.name), d || (d = J(), d.className = "jwblankDivider"));
                ...
                case m:
                    ...
                    for (var p = 0; p < u.length; p++) {
                        ...
                        if (x) {
                            ...
                            b(B(".jwrailgroup." + u[p]), {"min-width": g ? y : sa.width + C.width});
                            O.capSize = g ? sa.height + C.height : sa.width + C.width;
                            b(B("." + x.className), {left: g ? y : sa.width, right: g ? y : C.width, top: g ? sa.height : y, bottom: g ? C.height : y, height: g ? "auto" : y});
                            2 == p && (A = O);
                            K[w] = O;
                            d.appendChild(O)
                        }
                    ...
                    if (v = F(f + v + "Thumb", t, q, q, g))b(B("." + v.className),
                        {opacity: "time" == f ? 0 : 1, "margin-top": g ? v.skin.height / -2 : y}), v.className += " jwthumb", (g && A ? A : d).appendChild(v);
        ...
        function F(a, c, d, e, g) {
            ...
            e = H(a);
            h.innerHTML = "\x26nbsp;";
            if (e && "" != e.src)return d = d ? {background: "url('" + e.src + "') repeat-x " + k, height: g ? e.height : y} : {background: "url('" + e.src + "') no-repeat" + k, width: e.width, height: g ? e.height : y}, h.skin =
                e, b(B(".jw" + a), f.extend(d, c)), K[a] = h
        }

        function M(a, c, d) {
            c.src && (b(a, {width: c.width, background: "url(" + c.src + ") center no-repeat"}), d.src && b(a + ":hover", {background: "url(" + d.src + ") center no-repeat"}))
        }
        ...
        function H(a) {
            return(a = ba.getSkinElement(0 == a.indexOf("volume") ? "tooltip" : "controlbar", a)) ? a : {width: 0, height: 0, src: "", image: y, ready: q}
        }

        var G, ba, aa = u("divider", e), ya = {margin: 8, maxwidth: 800, font: "Arial,sans-serif", fontsize: 11, fontcolor: 15658734,
        ...
        ea.redraw = function () {
            ...
            b(B(".jwgroup.jwcenter"), {left: Math.round(f.parseDimension(Ba.left.offsetWidth) +
                a.width), right: Math.round(f.parseDimension(Ba.right.offsetWidth) + c.width)});
            a = S.parentNode.clientWidth > P.maxwidth;
            c = za ? 0 : P.margin;
            b(B(), {left: a ? "50%" : c, right: a ? y : c, "margin-left": a ? S.clientWidth / -2 : y, width: a ? l : y});
            var d;
            va = f.bounds(S);
            for (d in ta)X(ta[d])
        };
        ea.audioMode = function (a) {
            a != za && (za = a, b(B(".jwfullscreen"), {display: a ? "none" : y}), b(B(".jwhd"), {display: a ? "none" : y}), b(B(".jwcc"), {display: a ? "none" : y}), Da())
        };
        ea.element = function () {
            return S
        };
        ...
        I();
        var Ga = F("capLeft"),
            aa = F("capRight"), ab = F("background", {position: "absolute", left: H("capLeft").width, right: H("capRight").width, "background-repeat": "repeat-x"}, n);
        ab && S.appendChild(ab);
        Ga && S.appendChild(Ga);
        ma("left");
        ma("center");
        ...
        b(B(".jwright"), {right: H("capRight").width});
        aa && S.appendChild(aa);
        ...
        G.jwAddEventListener(d.JWPLAYER_PLAYER_STATE, function (c) {
            switch (c.newstate) {
                ...
                case a.PAUSED:
                    ...
                    break;
                case a.IDLE:
                    $("play", q), b(B(".jwtimeSliderThumb"), {opacity: 0}), K.timeRail && (K.timeRail.className = "jwrail", setTimeout(function () {
                        K.timeRail.className += " jwsmooth"
                    }, 100)), fa(0), x({position: 0, duration: 0})
            }
        });
    ...
    b(".jwcontrolbar .jwtime", {position: "absolute", height: l,
        width: l, left: 0});
...
(function (g) {
    ...
    h.controller = function (b, c) {
        ...
        function t(a) {
            return function () {
                s ? y(a, arguments) : A.push({method: a, arguments: arguments})
            }
        }
        ...
        this.playerReady =
            function (a) {
                if (!s) {
                    ...
                    w.sendEvent(g.events.JWPLAYER_PLAYLIST_LOADED, {playlist: p.playlist});
                    w.sendEvent(g.events.JWPLAYER_PLAYLIST_ITEM, {index: p.item});
                    e();
    ...
    g.display = function (m, l) {
        ...
        function q(b) {
            C != b ? (C && w(c, e), (C = b) ? (b = new Image, b.addEventListener("load",
                y, e), b.src = C) : (a("#" + u.id + " " + c, {"background-image": void 0}), w(c, e), D = A = 0)) : C && w(c, k);
            t(s.jwGetState())
        }
        ...
        function y() {
            ...
            t(s.jwGetState());
            z();
            C && a("#" + u.id + " " + c, {"background-image": "url(" + C + ")"})
        }
        ...
        function w(b, c) {
            h.exists(O[b]) || (O[b] = !1);
            O[b] != c && (O[b] = c, a("#" + u.id + " " + b, {opacity: c ? 1 : 0, visibility: c ? "visible" : "hidden"}))
        }

        var s = m, u, x, v, C, D, A, E = e, I = {}, B = e, J = e, O = {}, F, M, U, V = h.extend({showicons: k, bufferrotation: 45, bufferinterval: 100, fontcolor: "#ccc", overcolor: "#fff", fontsize: 15, fontweight: ""},
        ...
        var $ = {font: V.fontweight + " " + V.fontsize + "px/" + (parseInt(V.fontsize) + 3) + "px Arial,Helvetica,sans-serif", color: V.fontcolor};
        F = new g.displayicon(u.id + "_button", s, $, {color: V.overcolor});
        u.appendChild(F.element());
        n({newstate: d.IDLE})
    };
    a(".jwdisplay", {position: "absolute", cursor: "pointer", width: "100%", height: "100%", overflow: "hidden"});
    a(".jwdisplay .jwpreview", {position: "absolute", width: "100%", height: "100%", background: "no-repeat center",
...
(function (g) {
    ...
    g.displayicon = function (g, e, m, l) {
        ...
        x = n("capRight");
        v = 0 < u.width * x.width;
        var O = {"background-image": "url(" + u.src + "), url(" + g.src + "), url(" + x.src + ")", "background-position": "left,center,right", "background-repeat": "no-repeat",
            padding: "0 " + x.width + "px 0 " + u.width + "px", height: g.height, "margin-top": g.height / -2};
        f(j(), O);
    ...
    f(".jwdisplayIcon", {display: "table", cursor: "pointer", position: "relative", "margin-left": "auto", "margin-right": "auto", top: "50%"}, !0);
    f(".jwdisplayIcon div", {position: "relative", display: "table-cell", "vertical-align": "middle", "background-repeat": "no-repeat",
        "background-position": "center"});
    f(".jwdisplayIcon div", {"vertical-align": "middle"}, !0);
    f(".jwdisplayIcon .jwtext", {color: "#fff", padding: "0 1px", "max-width": "300px", "overflow-y": "hidden", "text-align": "center", "-webkit-user-select": b, "-moz-user-select": b, "-ms-user-select": b, "user-select": b})
})(jwplayer.html5);
(function (g) {
    ...
    g.dock = function (e, m) {
        function l(a, b) {
            var c = q(a);
            f(j("." + a), {width: c.width, background: c.src});
            return r("div", a, b)
        }
        ...
        function q(a) {
            return(a = p.getSkinElement("dock", a)) ? a : {width: 0, height: 0, src: ""}
        }

        function n() {
            f(a + " .capLeft, " + a + " .capRight", {display: z ? k : c})
        }

        var t = h.extend({},
            {iconalpha: 0.75, iconalphaactive: 0.5, iconalphaover: 1, margin: 8}, m), y = e.id + "_dock", p = e.skin, z = 0, w = {}, s = {}, u, x, v = this;
        v.redraw = function () {
            d(u)
        };
        v.element = function () {
        ...
        v.addButton = function (a, b, c, e) {
            if (!w[e]) {
                ...
                j.id = y + "_" + e;
                j.innerHTML = "\x26nbsp;";
                f("#" + j.id, {"background-image": a});
                "string" == typeof c && (c = new Function(c));
                k.addEventListener("click", c);
                w[e] = {element: k, label: b, divider: h, icon: j};
                if (b) {
        ...
        var C = q("button"), D = q("buttonOver"),
            A = q("buttonActive");
        C && (f(j(), {height: C.height, padding: t.margin}), f(a, {height: C.height}), f(j("button"), {width: C.width, cursor: "pointer", border: c, background: C.src}), D.src && f(j("button:hover"), {background: D.src}), A.src && f(j("button:active"), {background: A.src}), f(j("button\x3ediv"), {opacity: t.iconalpha}), f(j("button:hover\x3ediv"), {opacity: t.iconalphaover}), f(j("button:active\x3ediv"), {opacity: t.iconalphaactive}), f(j(".jwoverlay"), {top: t.margin + C.height}), l("capLeft", x), l("capRight", x), l("divider"));
        setTimeout(function () {
            d(u)
        })
    };
    f(".jwdock", {opacity: 0, display: c});
    f(".jwdock \x3e *", {height: "100%", "float": "left"});
    f(".jwdock \x3e .jwoverlay", {height: "auto", "float": c, "z-index": 99});
    f(a + " button", {position: "relative"});
    f(a + " \x3e *", {height: "100%", "float": "left"});
    f(a + " .divider", {display: c});
    f(a + " button ~ .divider", {display: k});
    f(a + " .capLeft, " + a + " .capRight", {display: c});
    f(a + " .capRight", {"float": "right"});
    f(a + " button \x3e div", {left: 0, right: 0, top: 0, bottom: 0, margin: 5, position: "absolute", "background-position": "center",
...
(function (g) {
    ...
    g.instream = function (c, h, e, m) {
        ...
        var t = {controlbarseekable: "never", controlbarpausable: !0, controlbarstoppable: !0, playlistclickable: !0}, y, p, z = e, w, s, u, x, v, C, D, A = !1, E, I, B, J = this;
...
(function (g) {
    ...
    f(".jwlogo", {cursor: "pointer", position: "absolute", "z-index": 100, opacity: 0});
...
(function (g) {
    ...
    h.menu = function (b, c, g, e) {
        ...
        function j(b) {
            return(b = g.getSkinElement("tooltip", b)) ? b : {width: 0, height: 0, src: a}
        }

        var r = e, q = new h.overlay(c + "_overlay", g);
        e = f.extend({fontcase: a, fontcolor: "#cccccc", fontsize: 11, fontweight: a, activecolor: "#ffffff", overcolor: "#ffffff"}, g.getComponentSettings("tooltip"));
        var n, t =
            [];
        this.element = function () {
            return q.element()
...
(function (g) {
    ...
    g.model = function (d, a) {
        ...
        var c = this, k, e, m = h.getCookies(), l = {controlbar: {}, display: {}}, j = {autostart: !1, controls: !0, debug: void 0, fullscreen: !1, height: 320, mobilecontrols: !1, mute: !1, playlist: [], playlistposition: "none", playlistsize: 180,
            repeat: !1, skin: void 0, stretching: h.stretching.UNIFORM, width: 480, volume: 90}, r = {};
        ...
        c.setFullscreen = function (a) {
            a != c.fullscreen && (c.fullscreen = a, c.sendEvent(f.JWPLAYER_FULLSCREEN, {fullscreen: a}))
        };
        c.setPlaylist = function (a) {
            ...
            b.playlist = d;
            0 == c.playlist.length ? c.sendEvent(f.JWPLAYER_ERROR, {message: "Error loading playlist: No playable sources found"}) : (c.sendEvent(f.JWPLAYER_PLAYLIST_LOADED, {playlist: a}), c.item = -1, c.setItem(0))
        };
        c.setItem = function (a) {
            a = a == c.playlist.length || -1 > a ? 0 : -1 == a || a > c.playlist.length ? c.playlist.length -
                1 : a;
            a != c.item && (c.item = a, c.sendEvent(f.JWPLAYER_PLAYLIST_ITEM, {index: c.item}))
        };
        c.setVolume = function (a) {
            c.mute && 0 < a && c.setMute(!1);
            a = Math.round(a);
            c.mute || h.saveCookie("volume", a);
            b({type: f.JWPLAYER_MEDIA_VOLUME, volume: a});
            k.volume(a)
        };
        c.setMute = function (a) {
            h.exists(a) || (a = !c.mute);
            h.saveCookie("mute", a);
            b({type: f.JWPLAYER_MEDIA_MUTE, mute: a});
            k.mute(a)
        };
        ...
        for (q in m)m[q] = h.serialize(m[q]);
        e.config =
            m;
        h.extend(c, {id: d.id, state: f.state.IDLE, duration: -1, position: 0, buffer: 0}, c.config);
        c.playlist = [];
        c.setItem(0);
...
(function (g) {
    var h = g.utils, f = h.css, d = h.transitionStyle, a = "top", b = "bottom", c = "right", k = "left", e = void 0, m = document, l = {fontcase: e, fontcolor: "#ffffff", fontsize: 12, fontweight: e, activecolor: "#ffffff", overcolor: "#ffffff"};
    g.html5.overlay = function (d, g, q) {
        ...
        function y(a, b) {
            var c;
            c = (c = w.getSkinElement("tooltip", a)) ? c : {width: 0, height: 0, src: "", image: e, ready: !1};
            var d = t(b, u);
            f(n(b.replace(" ",
        ...
        function p(d, g) {
            g || (g = "");
            var h = y("cap" + d + g, "jwborder jw" + d + (g ? g : "")), j = h[0], h = h[1], l = {"background-image": h.src, width: d == k || g == k || d == c || g == c ? h.width : e, height: d == a || g == a || d == b || g == b ? h.height : e};
            l[d] = d == b && !A || d == a && A ? D : 0;
            g && (l[g] = 0);
            f(n(j.className.replace(/ /g, ".")), l);
            j = {};
            l = {};
            h = {left: h.width, right: h.width, top: (A ? D : 0) + h.height, bottom: (A ? 0 : D) + h.height};
            g && (j[g] = h[g], j[d] = 0, l[d] = h[d], l[g] = 0, f(n("jw" + d), j), f(n("jw" + g), l), E[d] = h[d], E[g] = h[g])
        }

        function z() {
            0 !=
            u.clientWidth && (f(n(), {"margin-left": Math.round(v - u.clientWidth / 2)}), f(n("jwarrow"), {"margin-left": Math.round(C.width / -2 - v)}))
        }
        ...
        C = y("arrow", "jwarrow")[1];
        D = C.height;
        f(n("jwarrow"), {position: "absolute", bottom: A ? e : 0, top: A ? 0 : e, width: C.width, height: D, left: "50%"});
        p(a, k);
        p(b, k);
        p(a, c);
        p(b, c);
        ...
        p(b);
        y("background", "jwback");
        f(n("jwback"), {left: E.left, right: E.right, top: E.top, bottom: E.bottom});
        x = t("jwcontents", u);
        f(n("jwcontents") + " *", {color: d.fontcolor, font: d.fontweight + " " + d.fontsize + "px Arial,Helvetica,sans-serif",
            "text-transform": "upper" == d.fontcase ? "uppercase" : e});
        A && h.transform(n("jwarrow"), "rotate(180deg)");
        f(n(), {padding: E.top + 1 + "px " + E.right + "px " + (E.bottom + 1) + "px " + E.left + "px"});
        I.showing = !1
    };
    f(".jwoverlay", {position: "absolute", visibility: "hidden", opacity: 0});
    f(".jwoverlay .jwcontents", {position: "relative", "z-index": 1});
    f(".jwoverlay .jwborder", {position: "absolute", "background-size": "100% 100%"}, !0);
    f(".jwoverlay .jwback", {position: "absolute", "background-size": "100% 100%"});
...
(function (g) {
    ...
    g.player = function (f) {
        function d(a) {
            var b = {description: a.description, file: a.file, image: a.image, mediaid: a.mediaid, title: a.title}, c;
            for (c in a)b[c] = a[c];
            b.sources = [];
            b.tracks = [];
            if (0 < a.sources.length)for (c in a.sources) {
                var d = a.sources[c];
                b.sources.push({file: d.file, type: d.type ? d.type : void 0, label: d.label, "default": d["default"] ? !0 : !1})
            }
            if (0 < a.tracks.length)for (c in a.tracks)d = a.tracks[c], b.tracks.push({file: d.file, kind: d.kind ? d.kind : void 0, label: d.label, "default": d["default"] ?
                !0 : !1});
...
(function (g) {
    var h = {size: 180, backgroundcolor: "#333333", fontcolor: "#999999", overcolor: "#CCCCCC", activecolor: "#CCCCCC", titlecolor: "#CCCCCC", titleovercolor: "#FFFFFF", titleactivecolor: "#FFFFFF", fontweight: "normal", titleweight: "normal", fontsize: 11, titlesize: 13}, f = jwplayer.events, d = jwplayer.utils, a = d.css, b = document;
    g.playlistcomponent = function (c, k) {
        ...
        var j = c, r = j.skin, q = d.extend({}, h, j.skin.getComponentSettings("playlist"), k), n, t, y, p, z = -1, w, s, u = 60, x = {background: void 0, divider: void 0, item: void 0, itemOver: void 0, itemImage: void 0, itemActive: void 0};
        this.element = function () {
            return n
        };
        ...
        var C = v = r = 0;
        d.clearCss(e());
        a(e(), {"background-color": q.backgroundcolor});
        a(e("jwlist"), {"background-image": x.background ? " url(" + x.background.src + ")" : ""});
        a(e("jwlist *"), {color: q.fontcolor, font: q.fontweight + " " + q.fontsize + "px Arial, Helvetica, sans-serif"});
        x.itemImage ? (r = (u - x.itemImage.height) / 2 + "px ", v = x.itemImage.width, C = x.itemImage.height) : (v = 4 * u / 3, C = u);
        x.divider && a(e("jwplaylistdivider"), {"background-image": "url(" + x.divider.src + ")", "background-size": "100% " + x.divider.height +
            "px", width: "100%", height: x.divider.height});
        a(e("jwplaylistimg"), {height: C, width: v, margin: r ? r + r + r + r : "0 5px 0 0"});
        a(e("jwlist li"), {"background-image": x.item ? "url(" + x.item.src + ")" : "", height: u, "background-size": "100% " + u + "px", cursor: "pointer"});
        v = {overflow: "hidden"};
        "" !== q.activecolor && (v.color = q.activecolor);
        x.itemActive && (v["background-image"] = "url(" + x.itemActive.src + ")");
        a(e("jwlist li.active"), v);
        a(e("jwlist li.active .jwtitle"), {color: q.titleactivecolor});
        v = {overflow: "hidden"};
        "" !== q.overcolor &&
        (v.color = q.overcolor);
        x.itemOver && (v["background-image"] = "url(" + x.itemOver.src + ")");
        a(e("jwlist li:hover"), v);
        a(e("jwlist li:hover .jwtitle"), {color: q.titleovercolor});
        a(e("jwtextwrapper"), {height: u - 5, position: "relative"});
        a(e("jwtitle"), {height: 15, overflow: "hidden", display: "inline-block", width: "100%", color: q.titlecolor, "margin-top": r ? r : 7, "line-height": 13, "font-size": q.titlesize, "font-weight": q.titleweight});
        a(e("jwdescription"), {display: "block", "font-size": q.fontsize, "line-height": 19, "margin-top": 5,
            overflow: "hidden", height: u, position: "relative"});
        j.jwAddEventListener(f.JWPLAYER_PLAYLIST_LOADED, function () {
            ...
            if (y = c) {
                ...
                for (b = 0; b < y.length; b++) {
                    ...
                    if (c.image || c["playlist.image"] || x.itemImage)h = void 0, c["playlist.image"] ? h = c["playlist.image"] : c.image ? h = c.image : x.itemImage && (h = x.itemImage.src), a("#" + e.id + " .jwplaylistimg", {"background-image": h ? "url(" + h + ")" : null}), e.appendChild(f);
    ...
    a(".jwplaylist", {position: "absolute",
    ...
    g.playlistloader = function () {
        function a(a) {
            try {
                ...
                if ("rss" != g.parsers.localName(b))c("Not a valid RSS feed"); else {
                    var l = new h.playlist(g.parsers.rssparser.parse(b));
                    if (a = l) {
                        var b = [], j, r, q;
                        for (j = 0; j < a.length; j++)if (r = a[j], (q = f.filterSources(r.sources)) && q.length)r.sources = q, b.push(r);
                        l = b
                    } else l = void 0;
                    l && l.length && l[0].sources && l[0].sources.length && l[0].sources[0].file ? k.sendEvent(d.JWPLAYER_PLAYLIST_LOADED,
                        {playlist: l}) : c("No playable sources found")
                }
            } catch (n) {
                c()
            }
...
(function (g) {
    ...
    g.playlistslider = function (g, e, h, l) {
        ...
        function r(b, e, f, g) {
            ...
            b && (h.className = b, e && d(j(b), {"background-image": e.src ? e.src : c, "background-repeat": g ? "repeat-y" : "no-repeat", height: g ? c : e.height}));
            f && f.appendChild(h);
            return h
        }
        ...
        var V = this.redraw = function () {
            ...
            U = setTimeout(function () {
                if (l && l.clientHeight) {
                    ...
                    0 > a && (a = 0);
                    1 < a ? A = !1 : (A = !0, d(j("jwthumb"), {height: Math.max(s.clientHeight * a, J.height + O.height)}));
                    d(j(), {visibility: A ? "visible" :
                        "hidden"});
            ...
            d(j("jwthumb"), {top: F + (s.clientHeight - u.clientHeight) * v});
        ...
        r("jwrailback", B, s, !0);
        r("jwrailbottom", e, s);
        d(j("jwrailback"), {top: g.height, bottom: e.height});
        r("jwthumbtop", J, u);
        r("jwthumbback", h, u, !0);
        r("jwthumbbottom", O, u);
        d(j("jwthumbback"), {top: J.height, bottom: O.height});
        V();
    ...
    d(h("jwslider") + " *", {position: "absolute", width: "100%", "background-position": "center",
...
(function (g) {
    ...
    g.rightclick = function (b, c) {
        ...
        var m, l = h.extend({aboutlink: "http://www.longtailvideo.com/jwpabout/?a\x3dr\x26v\x3d" + g.version + "\x26m\x3dh\x26e\x3do", abouttext: "About JW Player " + g.version + "..."}, c), j = !1, r, q;
        this.element = function () {
            return r
        };
    ...
    f(".jwclick",
        ...
        !0);
    f(".jwclick div", {padding: "8px 21px", margin: "0px", "background-color": "#FFF", border: "none", "font-family": '"MS Sans Serif", "Geneva", sans-serif', "font-size": 10, color: "inherit"}, !0);
    f(".jwclick_item", {padding: "8px 21px", "text-align": "left", cursor: "pointer"}, !0);
    f(".jwclick_item:hover", {"background-color": "#595959", color: "#FFF"}, !0);
    f(".jwclick_item a", {"text-decoration": a, color: "#000"}, !0);
    f(".jwclick hr", {width: "100%", padding: 0, margin: 0, border: "1px #e9e9e9 solid"}, !0)
})(jwplayer.html5);
(function (g) {
    ...
    g.setup = function (e, h) {
        ...
        function z(a) {
            C = !0;
            v.sendEvent(d.JWPLAYER_ERROR, {message: a});
            s.setupError(a)
        }
    ...
    g.skinloader = function (d, a, b) {
        ...
        function e(a) {
            ...
            if (0 === a.length)q(r); else for (b = 0; b < a.length; b++) {
                var c =
                    j(a[b].getAttribute("name")), d = {settings: {}, elements: {}, layout: {}}, e = k(k(a[b], "elements")[0], "element");
                r[c] = d;
        ...
        function l(a, b) {
            ...
            r[b].elements[d] = {height: 0, width: 0, src: "", ready: !1, image: c};
            c.onload = function () {
...
(function (g) {
    ...
    g.html5.video = function (a) {
        ...
        function g() {
            F && (E == d.PLAYING && !A) && (x = Number(s.currentTime.toFixed(1)), b(f.JWPLAYER_MEDIA_TIME, {position: x, duration: u}))
        }

        function e(a) {
            F && (v || (v = !0, C || (C = !0, b(f.JWPLAYER_MEDIA_BUFFER_FULL))), "loadedmetadata" == a.type && (s.muted && (s.muted = !1, s.muted = !0), b(f.JWPLAYER_MEDIA_META, {duration: s.duration, height: s.videoHeight, width: s.videoWidth})))
        }
        ...
        function q(a) {
            if (!(a == d.PAUSED && E == d.IDLE) && !A && E != a) {
                var c = E;
                E = a;
                b(f.JWPLAYER_PLAYER_STATE, {oldstate: c, newstate: a})
            }
        }
        ...
        function n() {
            if (F) {
                ...
                a != J && (J = a, b(f.JWPLAYER_MEDIA_BUFFER, {bufferPercent: Math.round(100 * J)}));
                1 <= a && clearInterval(B)
            }
        }
        ...
        var y = h.isIE(), p = {abort: c, canplay: e, canplaythrough: c, durationchange: function () {
            if (F) {
            ...
            F && (h.log("Error playing media: %o", s.error), O.sendEvent(f.JWPLAYER_MEDIA_ERROR, {message: "Error loading media: File could not be played"}), q(d.IDLE))
        }, loadeddata: c, loadedmetadata: e, loadstart: c, pause: m, play: m, playing: m, progress: function () {
            v && (0 < D && !V) && (y ? setTimeout(ka, 200, D) : ka(D))
        }, ratechange: c, readystatechange: c, seeked: function () {
            A || (b(f.JWPLAYER_MEDIA_SEEK, {position: x, offset: s.currentTime}), E != d.PAUSED &&
                q(d.PLAYING))
        }, seeking: y ? l : c, stalled: c, suspend: c, timeupdate: g, volumechange: function () {
            b(f.JWPLAYER_MEDIA_VOLUME, {volume: Math.round(100 * s.volume)});
            b(f.JWPLAYER_MEDIA_MUTE, {mute: s.muted})
        }, waiting: l}, z, w, s, u, x, v, C, D, A, E = d.IDLE, I, B = -1, J = -1, O = new f.eventdispatcher, F = !1, M, U = -1, V = h.isAndroid(), N = this, ca = !1;
        h.extend(N, O);
        N.load = function (a) {
            if (F) {
                z = a;
                ...
                (a = j(M)) && O.sendEvent(f.JWPLAYER_MEDIA_LEVELS, {levels: a, currentQuality: U});
                r()
            }
        };
        N.stop = function () {
        ...
        N.setCurrentQuality = function (a) {
            U != a && (a = parseInt(a), 0 <= a && (M && M.length > a) && (U = a, h.saveCookie("qualityLabel", M[a].label), b(f.JWPLAYER_MEDIA_LEVEL_CHANGED,
                {currentQuality: a, levels: j(M)}), a = s.currentTime, r(), N.seek(a)))
        };
        ...
        s = a;
        for (var Ea in p)s.addEventListener(Ea, p[Ea], !1);
        s.controls = !0;
        s.controls = !1;
...
(function (g) {
    ...
    g.view = function (w, s) {
        ...
        function ka(b) {
            b = b && !P;
            a(pa(r),
                {visibility: b ? "visible" : y, opacity: b ? 1 : 0})
        }
        ...
        this.setup = function (a) {
            if (!K) {
                ...
                S = R.edition ? new g.rightclick(R, {abouttext: L.abouttext, aboutlink: L.aboutlink}) : new g.rightclick(R, {});
        ...
        this.setControls = function (a) {
            ...
            a =
                a ? n : t;
            L.controls = a;
            a != b && (a ? N() : (Q && (!P && !Y) && Q.hide(), H && (!oa && !Y) && H.hide(), V(), ca()), ra.sendEvent(f.JWPLAYER_CONTROLS, {controls: a}))
        };
        this.forceState = function (a) {
            T.forceState(a)
        };
    ...
    a(".jwplayer",
        {position: "relative", opacity: 0, "min-height": h.isMobile() ? 200 : 0, "-webkit-transition": "opacity .5s ease", "-moz-transition": "opacity .5s ease", "-o-transition": "opacity .5s ease"});
    a("." + j, {position: "absolute", left: 0, right: 0, top: 0, bottom: 0, "-webkit-transition": "opacity .5s ease", "-moz-transition": "opacity .5s ease", "-o-transition": "opacity .5s ease"});
    a("." + r + " ,.jwcontrols", {position: "absolute", height: "100%", width: "100%", "-webkit-transition": "opacity .5s ease", "-moz-transition": "opacity .5s ease", "-o-transition": "opacity .5s ease"});
    a("." + r, {overflow: y, visibility: y, opacity: 0, cursor: "pointer"});
    a("." + r + " video", {background: "transparent", width: "100%", height: "100%"});
    a("." + q, {position: "absolute", height: "100%", width: "100%", display: p});
    a(".jwinstream", {position: "absolute", top: 0, left: 0, bottom: 0, right: 0, display: "none"});
    a(".jwplayer.jwfullscreen", {width: "100%", height: "100%", left: 0, right: 0, top: 0, bottom: 0, "z-index": 1E3, position: "fixed"}, n);
    a(".jwplayer.jwfullscreen ." + j, {left: 0, right: 0, top: 0, bottom: 0}, n);
...
(function (g) {
    ...
    g.rightclick = function (d, a) {
        if ("free" == d.edition())a.aboutlink = "http://www.longtailvideo.com/jwpabout/?a\x3dr\x26v\x3d" + g.version + "\x26m\x3dh\x26e\x3df", delete a.abouttext; else {
            if (!a.aboutlink) {
