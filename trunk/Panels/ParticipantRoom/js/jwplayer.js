"undefined" == typeof jwplayer && (jwplayer = function (d) {
    ...
    var h = {code: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d", encode: function (a, b) {
    ...
    d.events = {COMPLETE: "COMPLETE", ERROR: "ERROR", API_READY: "jwplayerAPIReady", JWPLAYER_READY: "jwplayerReady", JWPLAYER_FULLSCREEN: "jwplayerFullscreen", JWPLAYER_RESIZE: "jwplayerResize", JWPLAYER_ERROR: "jwplayerError", JWPLAYER_MEDIA_BEFOREPLAY: "jwplayerMediaBeforePlay", JWPLAYER_MEDIA_BEFORECOMPLETE: "jwplayerMediaBeforeComplete", JWPLAYER_COMPONENT_SHOW: "jwplayerComponentShow", JWPLAYER_COMPONENT_HIDE: "jwplayerComponentHide",
    ...
    d.eventdispatcher = function (d, g) {
        ...
        this.addEventListener = function (b, k, d) {
            try {
                a.exists(c[b]) || (c[b] = []), "string" == a.typeOf(k) && (k = (new Function("return " + k))()), c[b].push({listener: k, count: d})
            } catch (g) {
                a.log("error", g)
            }
            return!1
        ...
        this.sendEvent = function (e, k) {
            a.exists(k) || (k = {});
            a.extend(k, {id: d, version: jwplayer.version,
                type: e});
            g && a.log(e, k);
    ...
    function (d) {
        ...
        d.plugin = function (g) {
            ...
            a.extend(this,
                j);
            this.load = function () {
                if (k == a.loaderstatus.NEW)if (0 < g.lastIndexOf(".swf"))l = g, k = a.loaderstatus.COMPLETE, j.sendEvent(h.COMPLETE); else if (a.getPluginPathType(g) == a.pluginPathType.CDN)k = a.loaderstatus.COMPLETE, j.sendEvent(h.COMPLETE); else {
    ...
    d.plugins.pluginloader = function (g, c) {
        function b() {
            m ? j.sendEvent(h.ERROR, {message: n}) : l || (l = !0, k = a.loaderstatus.COMPLETE, j.sendEvent(h.COMPLETE))
        }
        ...
        function e() {
            ...
            if (!l && !m) {
                ...
                for (f in q) {
                    ...
                    if (h == a.loaderstatus.LOADING || h == a.loaderstatus.NEW)e++; else if (k && (!j || parseFloat(j) > parseFloat(d.version)))m = !0, n = "Incompatible player version", b()
                }
                0 == e && b()
            }
        }
        ...
        this.setupPlugins = function (b, e, c) {
            var f = {length: 0, plugins: {}}, d = 0, k = {}, h = g.getPlugins(), l;
            for (l in e.plugins) {
    ...
    var a = jwplayer.utils, h = {file: void 0, label: void 0, type: void 0, "default": void 0};
    d.source = function (d) {
        var c = a.extend({}, h), b;
    ...
    var a = jwplayer.utils, h = {file: void 0, label: void 0,
    ...
    var a = d.utils, h = d.events, g = document, c = d.embed = function (b) {
        ...
        s.addEventListener(h.COMPLETE, function () {
            if ("array" == a.typeOf(m.playlist) && 2 > m.playlist.length && (0 == m.playlist.length || !m.playlist[0].sources || 0 == m.playlist[0].sources.length))k(); else if (s.getStatus() == a.loaderstatus.COMPLETE) {
    ...
    (d.embed.config = function (b) {
        var e = {fallback: !0, height: 270, primary: "html5", width: 480, base: b.base ? b.base : g.getScriptPath("jwplayer.js")};
        b = g.extend(e, d.defaults, b);
        var e = {type: "html5", src: b.base + "jwplayer.html5.js"}, c = {type: "flash",
    ...
    (d.embed.flash = function (c, b, e, k, l) {
        ...
        this.embed = function () {
            e.id = l.id;
            if (10 > f)return j.sendEvent(h.ERROR, {message: "Flash version must be 10.0 or greater"}),
                !1;
            var d, p = a.extend({}, e);
                ...
                try {
                    ...
                    for (var c = 0; c < b.length; c++) {
                        ...
                        if (d = b[c].file) {
                            ...
                            if (a.isYouTube(g) || a.isRtmp(g, k) || "hls" == k)d = !0; else {
        ...
        q.supportsConfig = function () {
            if (d.vid.canPlayType)try {
                ...
                for (var b = e.playlist[0].sources, c = 0; c < b.length; c++) {
                    ...
                    if (null !== navigator.userAgent.match(/BlackBerry/i) || a.isAndroid() && ("m3u" == a.extension(k) || "m3u8" == a.extension(k)) || a.isRtmp(k, j))g = !1; else {
    ...
    var a = [], h = d.utils, g = d.events, c = g.state, b = document, e = d.api = function (a) {
        ...
        function m(a, b) {
            p[a] || (p[a] = [], q(g.JWPLAYER_PLAYER_STATE, function (b) {
                ...
                if (c == a) {
                    var e = p[c];
                    if (e)for (var d = 0; d < e.length; d++)"function" == typeof e[d] && e[d].call(this, {oldstate: b, newstate: c})
                }
            }));
            p[a].push(b);
            return f
        ...
        f.resize = function (a, c) {
            if ("flash" != f.renderingMode)j("jwResize", a, c); else {
        ...
        var z = {onBufferChange: g.JWPLAYER_MEDIA_BUFFER, onBufferFull: g.JWPLAYER_MEDIA_BUFFER_FULL, onError: g.JWPLAYER_ERROR, onFullscreen: g.JWPLAYER_FULLSCREEN,
            ...
            onQualityLevels: g.JWPLAYER_MEDIA_LEVELS, onQualityChange: g.JWPLAYER_MEDIA_LEVEL_CHANGED, onCaptionsList: g.JWPLAYER_CAPTIONS_LIST, onCaptionsChange: g.JWPLAYER_CAPTIONS_CHANGED};
        h.foreach(z, function (a) {
            f[a] = l(z[a], q)
        });
        var A = {onBuffer: c.BUFFERING, onPause: c.PAUSED, onPlay: c.PLAYING, onIdle: c.IDLE};
