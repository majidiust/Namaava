...
(function () {
    ...
    CKEDITOR.plugins.add("colorbutton", {requires: "panelbutton,floatpanel", init: function (c) {
        function m(l, g, e, h) {
            ...
            c.ui.add(l, CKEDITOR.UI_PANELBUTTON, {label: e, title: e, modes: {wysiwyg: 1}, editorFocus: 0, toolbar: "colors," + h, allowedContent: j, requiredContent: j, panel: {css: CKEDITOR.skin.getPath("editor"), attributes: {role: "listbox", "aria-label": f.panelTitle}}, onBlock: function (a, b) {
                b.autoSize = !0;
    ...
    CKEDITOR.plugins.add("forms", {requires: "dialog,fakeobjects", onLoad: function () {
        ...
        var a = b.lang, e = 0, h = {email: 1, password: 1, search: 1, tel: 1, text: 1, url: 1}, j = {checkbox: "input[type,name,checked]",
            ...
            hiddenfield: "input", imagebutton: "input"}, d = function (g, c, d) {
        ...
        b.contextMenu && (!b.blockless && b.contextMenu.addListener(function (g, c, b) {
            if ((g = b.contains("form", 1)) && !g.isReadOnly())return{form: CKEDITOR.TRISTATE_OFF}
    ...
    (function () {
        ...
        CKEDITOR.plugins.add("pagebreak", {requires: "fakeobjects", onLoad: function () {
            ...
            a.blockless || (a.addCommand("pagebreak", CKEDITOR.plugins.pagebreakCmd), a.ui.addButton && a.ui.addButton("PageBreak", {label: a.lang.pagebreak.toolbar, command: "pagebreak", toolbar: "insert,70"}), CKEDITOR.env.opera && a.on("contentDom", function () {
